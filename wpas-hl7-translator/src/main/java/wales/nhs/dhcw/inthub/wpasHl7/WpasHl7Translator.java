...
//        queueDateTime =
    ...
    AbstractMessage translate(MAINDATA wpasXml, OffsetDateTime queueDateTime) throws DataTypeException {
        switch (wpasXml.getTRANSACTION().getMSGID()) {
            case "MPI":
                return mpiToAdtA28Mapper.translateMpiToAdtA28(wpasXml.getTRANSACTION());
            case "MPR":
                return mprToAdtA39Mapper.ADT_A40Mapper(wpasXml.getTRANSACTION(),queueDateTime);
            default:

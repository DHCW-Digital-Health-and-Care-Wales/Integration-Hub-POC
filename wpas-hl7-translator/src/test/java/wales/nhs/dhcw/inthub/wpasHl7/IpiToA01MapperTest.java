...
public class IpiToA01MapperTest {
    private static final String WPAS_IPI_XML_PATH = "wpas-ipi.xml";
    private static final String EXPECTED_A01_PATH = "adt_a01.hl7.xml";
    ...
    @Test
    void WpasIpiMessage_Is_translatedToAdtA01() throws HL7Exception, JAXBException, SAXException {
        // Arrange
        var wpasMessage = parser.parse(TestUtil.getTestFileStream(WPAS_IPI_XML_PATH));
        var expected = TestUtil.getTestFileContent(EXPECTED_A01_PATH);
